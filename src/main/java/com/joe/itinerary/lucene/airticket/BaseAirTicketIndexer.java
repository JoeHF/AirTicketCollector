...
abstract class BaseAirTicketIndexer implements AirTicketIndexerService {
  ...
  BaseAirTicketIndexer() throws IOException {
    // this directory will contain the indexes
    Directory indexDirectory = FSDirectory.open(new File(getIndexDir()).toPath());
